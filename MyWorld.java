...
public class MyWorld extends World
{
    ...
    public int actor = 0; //can't help but wonder why this variable is just called 'a' //changed variable to "actor" which should make more sense.
...
//The below method increses the score on the score board and also shows the win message once 10 has been reached. This will then stop the game.
...
//the below spawns the fireflies and flies in randomised place in the game.
